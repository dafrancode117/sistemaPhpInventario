<!-- //* Vista del las pagina de Usuarios Nuevos *//  -->
		  	...
		  	<div class="column">
		    	<div class="control">
					...
					<!-- El atributo pattern nos permite agregar una expresion regular al valor agregado en el input -->
				  	<input class="input" type="text" name="usuario_nombre" pattern="^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]{3,40}$" maxlength="40" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
					<label>Apellidos</label>
				  	<input class="input" type="text" name="usuario_apellido" pattern="^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]{3,40}$" maxlength="40" required >
				</div>
		  	</div>
		</div>
		<div class="columns">
